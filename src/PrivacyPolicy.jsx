...
const PrivacyPolicy = () => {
    return (
        <div>
            <h1 className={"mt-1"}>Datenschutzerklärung
                ...
                Bestellungen oder sonstige Auftragsanfragen verarbeitet. Welche Rechte haben Sie bezüglich Ihrer Daten?
            ...
            <h1>
                2. Hosting
                Wir hosten die Inhalte unserer Website selber.
            </h1>
            <h1>
                ...
                automatisiert verarbeiten, an sich oder an einen Dritten in einem gängigen, maschinenlesbaren Format aushändigen zu lassen. Sofern Sie die direkte Übertragung der Daten an einen anderen Verantwortlichen
